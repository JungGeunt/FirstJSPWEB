...
<html>
	<head>
		<meta charset="UTF-8">
		<title>form을 이용한 get방식의 데이터 전당</title>
	</head>
	<body>
		<!-- form 안에작성된 데이터를 서버에 전달할때, form태그 사용 예시 -->
		<form action="req_get_parameter.jsp">
			...
			<input type ="radio" name ="major" value="경영">경연
			<br>	
			통신사:<!-- select -->
			<select name="phone">
				<option>SKT</option>
			...
			주소:<input type="text" size="50" name="adreess"><br>
			<br>

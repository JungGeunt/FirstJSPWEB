...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%--
    	...
    	1.page	:JSP 페이지에 대한 정보를 지정. JSP가 생성하는 문서의 타입, 임포트, 에러 페이지등
    			...
    			b. import		:패키지를 import할 떄 사용!
    			c. errorPage	:설정된 페잉지에서 에러가 발생했을 시 미리 만들어 둔 에러 페이지 호출
    			d. contentType	:text/html 이라고 쓰면, 결과가 html 문서로 만들어짐.
    	...
    	<%@page language= "java" contentType= "text/html; charset=URF-8" pageEncoding+URF-8">
